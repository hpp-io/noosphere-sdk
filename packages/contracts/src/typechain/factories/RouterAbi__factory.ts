...
const _abi = [
  ...
  {
    type: "function",
    name: "getIntervalAndValidateWallets",
    inputs: [
      {
        name: "subscriptionId",
        type: "uint64",
  ...
  {
    type: "function",
    name: "unlockAndPayForVerification",
    inputs: [
      {
        name: "proofRequest",
        type: "tuple",
  ...
  {
    type: "error",
    name: "InvalidWalletFactoryAddress",
    inputs: [],
  },
  {
    type: "error",
